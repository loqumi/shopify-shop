...
export type HistoryProductVariantFragment = Pick<
...
export type HistoryProductFragment = Pick<
...
export type RelatedProductQueryVariables = StorefrontAPI.Exact<{
  productId: StorefrontAPI.Scalars['ID']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type RelatedProductQuery = {
  product?: StorefrontAPI.Maybe<
...
export type CollectionByQueryFragment = Pick<
  StorefrontAPI.Collection,
...
export type CollectionsByQueryQueryVariables = StorefrontAPI.Exact<{
...
export type CollectionsByQueryQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
export type PromotionsCollectionFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle' | 'description'
> & {image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'url'>>};

export type PromotionsCollectionsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type PromotionsCollectionsQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
export type StoriesCollectionFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle' | 'description'
> & {
  image?: StorefrontAPI.Maybe<
...
export type StoriesCollectionsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type StoriesCollectionsQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
export type VideoCollectionProductFragment = Pick<
  StorefrontAPI.Product,
  | 'id'
  | 'title'
  | 'vendor'
...
export type VideoCollectionFragment = Pick<
  StorefrontAPI.Collection,
  'description'
> & {
  products: {
...
export type VideoCollectionQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type VideoCollectionQuery = {
  collection?: StorefrontAPI.Maybe<
...
export type CategoryProductVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
  'title' | 'id' | 'availableForSale'
> & {
  compareAtPrice?: StorefrontAPI.Maybe<
...
> & {
  images: {
    edges: Array<{
      node: {__typename: 'Image'} & Pick<StorefrontAPI.Image, 'id' | 'url'>;
    }>;
  };
  options: Array<Pick<StorefrontAPI.ProductOption, 'name' | 'values'>>;
  seo: Pick<StorefrontAPI.Seo, 'description' | 'title'>;
...
export type GetCategoryProductsQueryVariables = StorefrontAPI.Exact<{
  categoryName: StorefrontAPI.Scalars['String']['input'];
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
  last?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
  startCursor?: StorefrontAPI.InputMaybe<
    StorefrontAPI.Scalars['String']['input']
...
export type NewProductVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
...
export type MaxPriceQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type MaxPriceQuery = {
  products: {
    edges: Array<{
...
export type SearchNewProductVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
  'availableForSale' | 'id' | 'sku' | 'title'
> & {
  compareAtPrice?: StorefrontAPI.Maybe<
...
export type RegularSearchQueryVariables = StorefrontAPI.Exact<{
  ...
  startCursor?: StorefrontAPI.InputMaybe<
    StorefrontAPI.Scalars['String']['input']
  >;
  available?: StorefrontAPI.InputMaybe<StorefrontAPI.SearchUnavailableProductsType>;
  min?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Float']['input']>;
  max?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Float']['input']>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query RelatedProduct(\n    $productId: ID!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    product(id: $productId) {\n      id\n      title\n      description\n      handle\n      images(first: 1) {\n        edges {\n          node {\n            url\n            altText\n          }\n        }\n      }\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      variants(first: 1) {\n        nodes {\n          id\n          title\n          sku\n          availableForSale\n          compareAtPrice {\n            amount\n            currencyCode\n          }\n          image {\n            id\n            url\n            altText\n            width\n            height\n          }\n          price {\n            amount\n            currencyCode\n          }\n          product {\n            title\n            handle\n          }\n          selectedOptions {\n            name\n            value\n          }\n          unitPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: RelatedProductQueryVariables;
  };
  ...
  '#graphql\n  fragment CollectionByQuery on Collection {\n    id\n    title\n    handle\n    description\n    image {\n      altText\n      url\n      __typename\n    }\n    metafield (key: "header", namespace: "collection") {\n      value\n    }\n  }\n  query CollectionsByQuery(\n      $query: String! \n      $first: Int\n      $last: Int\n      $startCursor: String\n      $endCursor: String\n    ) {\n    collections(query: $query, first: $first, last: $last, before: $startCursor, after: $endCursor) {\n      nodes {\n        ...CollectionByQuery\n      }\n      pageInfo {\n        hasPreviousPage\n        hasNextPage\n        startCursor\n        endCursor\n      }\n    }\n  }\n': {
    return: CollectionsByQueryQuery;
    variables: CollectionsByQueryQueryVariables;
  };
  '#graphql\n  fragment PromotionsCollection on Collection {\n    id\n    title\n    handle\n    description\n    image {\n      url\n    }\n  }\n  query PromotionsCollections {\n    collections(first: 4, query: "title:promotions*") {\n      nodes {\n        ...PromotionsCollection\n      }\n    }\n  }\n': {
    return: PromotionsCollectionsQuery;
    variables: PromotionsCollectionsQueryVariables;
  };
  '#graphql\n  fragment StoriesCollection on Collection {\n    id\n    title\n    handle\n    description\n    image {\n      altText\n      url\n      __typename\n    }\n    metafield (key: "header", namespace: "collection") {\n      value\n    }\n  }\n  query StoriesCollections {\n    collections(first: 10, query: "title:stories*") {\n      nodes {\n        ...StoriesCollection\n      }\n    }\n  }\n': {
    return: StoriesCollectionsQuery;
    variables: StoriesCollectionsQueryVariables;
  };
  '#graphql\n  fragment VideoCollectionProduct on Product {\n    id\n    title\n    vendor\n    handle\n    productType\n    publishedAt\n    description\n    descriptionHtml\n    images(first: 1) {\n      edges {\n        node {\n          id\n          url\n        }\n      }\n    }\n    options {\n      name\n      values\n    }\n    variants(first: 1) {\n      nodes {\n        availableForSale\n        id\n        sku\n        title\n        compareAtPrice {\n          amount\n          currencyCode\n        }\n        image {\n          __typename\n          id\n          url\n          altText\n          width\n          height\n        }\n        price {\n          amount\n          currencyCode\n        }\n        product {\n          title\n          handle\n        }\n        selectedOptions {\n          name\n          value\n        }\n        unitPrice {\n          amount\n          currencyCode\n        }\n      }\n    }\n    seo {\n      description\n      title\n    }\n  }\n  fragment VideoCollection on Collection {\n    description\n    products (first: 10) {\n      nodes{\n        ...VideoCollectionProduct\n      }\n    }\n  }\n  query VideoCollection {\n    collection(handle: "video-collection") {\n      ...VideoCollection\n    }\n  }\n': {
    ...
    variables: VideoCollectionQueryVariables;
  };
  ...
  '#graphql\n  query maxPrice {\n    products(sortKey: PRICE, first: 1, reverse: true) {\n      edges {\n        node {\n          id\n          priceRange {\n            maxVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: MaxPriceQueryVariables;
  };

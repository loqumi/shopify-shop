...
function SearchResultsPredictiveProducts({
  ...
  return (
    <div className="predictive-search-result p-3" key="products">
      <div className={'grid grid-cols-2 md:grid-cols-4 gap-12'}>
        {products.map((product) => (
          <button key={product.id} onClick={closeSearch}>
            <ProductItemUpdated
...
function SearchResultsPredictiveEmpty({
  ...
  return (
    <p
      className={'!font-black text-center !text-lg font-fraunces truncate p-6'}
    >
...
function usePredictiveSearch(): UsePredictiveSearchReturn {
  ...
  useEffect(() => {
    if (!inputRef.current) {
      inputRef.current = document.querySelector('input[type="text"]');
    }
  }, []);
